...
Позитивное и негативное тестирование являются техниками тест-дизайна, используемыми для проверки функциональности или безопасности программного обеспечения. Эти техники позволяют выявить различные аспекты работы программы:
